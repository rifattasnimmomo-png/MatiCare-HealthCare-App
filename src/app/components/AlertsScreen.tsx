        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            {action && (
              <Button
                size="sm"
                className={`mt-3 ${severity === 'emergency' ? 'bg-rose-600 hover:bg-rose-700' : 'bg-[#FFC0CB] hover:bg-[#FFB6C1]'} text-white`}
              >
                {action}
              </Button>
            )}
...
export function AlertsScreen() {
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen pb-24">
      {/* Header */}
      <div className="bg-[#FFC0CB] px-6 pt-12 pb-6 rounded-b-[32px]">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <Card className="border-none bg-white dark:bg-gray-800 shadow-md">
            <CardContent className="p-4 text-center">
              <div className="w-10 h-10 bg-[#FFC0CB] rounded-full flex items-center justify-center mx-auto mb-2">
        ...
        <div className="pt-6">
          ...
          <div className="space-y-3">
            <Card className="border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm opacity-75">
              <CardContent className="p-5">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-gradient-to-br from-[#FFC0CB] to-[#FFB6C1] rounded-full flex items-center justify-center flex-shrink-0">
                    <CheckCircle className="w-5 h-5 text-white" />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="text-gray-700 dark:text-gray-300 font-medium">Preeclampsia Risk</h3>
                      <Badge className="bg-[#FFC0CB] text-white text-xs border-none">Resolved</Badge>
                    </div>
      ...
      <div className="px-6 mt-6">
        <Card className="border-none shadow-md bg-gradient-to-br from-[#FFE4E9] dark:from-pink-900/30 to-white dark:to-gray-800">
          <CardContent className="p-5">
            <div className="flex items-start gap-3">
              <PhoneCall className="w-5 h-5 text-[#FFC0CB] flex-shrink-0 mt-0.5" />
              <div>
