  ...
  return (
    <div className="bg-slate-50 dark:bg-gray-900 min-h-screen pb-24">
      ...
      <div className="px-6 py-6">
        <Card className="border-[#FFC0CB] dark:border-pink-800 bg-[#FFE4E9] dark:bg-pink-900/20">
          <CardContent className="p-5">
            <div className="flex items-start gap-3 mb-4">
              <AlertCircle className="w-6 h-6 text-[#FFC0CB] flex-shrink-0" />
              <div>
                ...
                <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5 text-[#FFC0CB]" />
      ...
      <div className="px-6 mb-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <Badge className="bg-[#FFC0CB] text-white text-xs">Primary</Badge>
                  </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <Badge className="bg-pink-100 dark:bg-pink-900/30 text-[#FFC0CB] text-xs">Doctor</Badge>
                  </div>
        ...
        <Button className="w-full mt-4 bg-[#FFC0CB] hover:bg-[#FFB6C1] text-white h-12">
          ...
          <CardContent className="p-5">
            <div className="space-y-4">
              ...
              <button className="w-full flex items-center justify-between p-4 bg-slate-50 dark:bg-gray-700 border border-slate-200 dark:border-gray-600 rounded-xl hover:bg-slate-100 dark:hover:bg-gray-600 transition-colors">
                ...
                <Phone className="w-5 h-5 text-[#FFC0CB]" />
              </button>
        ...
        <Card className="border-slate-200 dark:border-gray-700 dark:bg-gray-800">
          <CardContent className="p-5">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <MapPin className="w-5 h-5 text-[#FFC0CB]" />
                <div>
      ...
      <div className="px-6">
        <Card className="border-slate-200 dark:border-gray-700 dark:bg-gray-800">
          <CardContent className="p-5">
            ...
            <Button variant="outline" className="w-full border-[#FFC0CB] text-[#FFC0CB] hover:bg-pink-50 dark:hover:bg-pink-900/30">
