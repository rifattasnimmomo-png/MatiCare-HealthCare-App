  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen pb-24">
      ...
      <div className="px-6 py-6">
        <Card className="border-none bg-[#FFE4E9] dark:bg-pink-900/30 shadow-sm">
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              <Info className="w-5 h-5 text-[#FFC0CB] flex-shrink-0 mt-0.5" />
              <div>
                <Badge className="bg-[#FFC0CB] text-white text-xs mb-2 border-none">Phase 2 Feature</Badge>
        ...
        <Card className="border-gray-200 dark:border-gray-700 dark:bg-gray-800 shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="w-20 h-20 bg-[#FFE4E9] dark:bg-pink-900/30 rounded-full flex items-center justify-center">
                <Activity className="w-10 h-10 text-[#FFC0CB]" />
              </div>
            </div>

            <div className="bg-[#FFC0CB]/10 border border-[#FFC0CB] dark:border-pink-700 rounded-xl p-4 mb-4">
            ...
            <Button className="w-full mt-6 bg-[#FFC0CB] hover:bg-[#FFB6C1] text-white">
              Log Movement
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-gray-200 dark:border-gray-700 dark:bg-gray-800 shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center gap-3 mb-4">
              <TrendingUp className="w-5 h-5 text-[#FFC0CB]" />
              <div>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={item.day} className="flex items-center gap-3">
                  <p className={`text-xs w-12 ${item.active ? 'text-[#FFC0CB] font-semibold' : 'text-gray-600 dark:text-gray-400'}`}>
                    {item.day}
                  </p>
                  <div className="flex-1 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                    <div
                      className={`h-2 rounded-full ${item.active ? 'bg-[#FFC0CB]' : 'bg-pink-400 dark:bg-pink-600'}`}
          ...
          <Card className="border-gray-200 dark:border-gray-700 dark:bg-gray-800 shadow-sm">
            <CardContent className="p-5">
              <h3 className="text-gray-900 dark:text-white font-medium mb-2 flex items-center gap-2">
                <Calendar className="w-5 h-5 text-[#FFC0CB]" />
                Week 18
              </h3>
            ...
            <CardContent className="p-5">
              ...
              <ul className="space-y-2">
                <li className="text-sm text-gray-700 dark:text-gray-300 flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-[#FFC0CB] rounded-full mt-1.5 flex-shrink-0" />
        ...
        <Card className="border-gray-200 dark:border-gray-700 dark:bg-gray-800 shadow-sm">
          <CardContent className="p-5">
            ...
            <div className="space-y-3">
              ...
              <Button variant="outline" className="w-full border-[#FFC0CB] text-[#FFC0CB] hover:bg-[#FFE4E9] dark:hover:bg-pink-900/30">
