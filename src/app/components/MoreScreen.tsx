import { Heart, Calendar, CreditCard, MessageCircle, LogOut, ChevronRight, Users, Phone, Shield, Settings, HelpCircle, Info, UserRound } from 'lucide-react';
    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen pb-24">
      ...
      <div className="px-6 pt-16 pb-8">
        <div className="flex flex-col items-center">
          <div className="w-32 h-32 rounded-full bg-[#FFE4E9] dark:bg-pink-900/30 flex items-center justify-center mb-4 border-4 border-[#FFC0CB]">
            <UserRound className="w-20 h-20 text-[#FFC0CB]" strokeWidth={1.5} />
          </div>
      ...
      <div className="px-6 mb-8">
        <div className="grid grid-cols-3 gap-4">
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 bg-[#FFE4E9] dark:bg-pink-900/30 rounded-2xl flex items-center justify-center mb-2">
              <Heart className="w-7 h-7 text-[#FFC0CB]" fill="#FFC0CB" />
            </div>
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Heart rate</p>
            <p className="text-xl font-semibold text-[#FFC0CB]">215bpm</p>
          </div>
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 bg-[#FFE4E9] dark:bg-pink-900/30 rounded-2xl flex items-center justify-center mb-2">
              <svg className="w-7 h-7 text-[#FFC0CB]" fill="#FFC0CB" viewBox="0 0 24 24">
            ...
            <p className="text-xl font-semibold text-[#FFC0CB]">756cal</p>
          </div>
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 bg-[#FFE4E9] dark:bg-pink-900/30 rounded-2xl flex items-center justify-center mb-2">
              <svg className="w-7 h-7 text-[#FFC0CB]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                <circle cx="12" cy="12" r="3" />
                <path d="M12 2v7m0 6v7M2 12h7m6 0h7" />
              </svg>
            </div>
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Weight</p>
            <p className="text-xl font-semibold text-[#FFC0CB]">103lbs</p>
          </div>
        </div>
      </div>
        ...
        {menuItems.map((item, index) => {
          ...
          return (
            <div key={item.id}>
              ...
              >
                <div className="w-12 h-12 bg-[#FFE4E9] dark:bg-pink-900/30 rounded-2xl flex items-center justify-center flex-shrink-0">
                ...
                <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-[#FFC0CB] transition-colors" />
              </button>
