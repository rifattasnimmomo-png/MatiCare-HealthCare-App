    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen pb-24">
      ...
      <div className="px-6 pt-16 pb-8">
        <div className="flex flex-col items-center">
          <div className="w-32 h-32 rounded-full overflow-hidden mb-4 border-4 border-[#FF69B4]">
            <img 
              src={imgProfilePic} 
              alt="Profile" 
      ...
      <div className="px-6 mb-8">
        <div className="grid grid-cols-3 gap-4">
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 bg-[#FFE6F7] dark:bg-pink-900/30 rounded-2xl flex items-center justify-center mb-2">
              <Heart className="w-7 h-7 text-[#FF69B4]" fill="#FF69B4" />
            </div>
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Heart rate</p>
            <p className="text-xl font-semibold text-[#FF69B4]">215bpm</p>
          </div>
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 bg-[#FFE6F7] dark:bg-pink-900/30 rounded-2xl flex items-center justify-center mb-2">
              <svg className="w-7 h-7 text-[#FF69B4]" fill="#FF69B4" viewBox="0 0 24 24">
            ...
            <p className="text-xl font-semibold text-[#FF69B4]">756cal</p>
          </div>
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 bg-[#FFE6F7] dark:bg-pink-900/30 rounded-2xl flex items-center justify-center mb-2">
              <svg className="w-7 h-7 text-[#FF69B4]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                <circle cx="12" cy="12" r="3" />
                <path d="M12 2v7m0 6v7M2 12h7m6 0h7" />
              </svg>
            </div>
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Weight</p>
            <p className="text-xl font-semibold text-[#FF69B4]">103lbs</p>
          </div>
        </div>
      </div>
        ...
        {menuItems.map((item, index) => {
          ...
          return (
            <div key={item.id}>
              ...
              >
                <div className="w-12 h-12 bg-[#FFE6F7] dark:bg-pink-900/30 rounded-2xl flex items-center justify-center flex-shrink-0">
