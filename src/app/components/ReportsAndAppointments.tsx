    ...
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen pb-24">
      ...
      <Tabs defaultValue="reports" className="px-6 pt-6">
        <TabsList className="w-full grid grid-cols-2 h-auto bg-gray-100 dark:bg-gray-800 p-1 mb-6 rounded-xl">
          <TabsTrigger value="reports" className="py-3 rounded-lg data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700 data-[state=active]:text-[#FF69B4]">
            <FileText className="w-4 h-4 mr-2" />
            Reports
          </TabsTrigger>
          <TabsTrigger value="appointments" className="py-3 rounded-lg data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700 data-[state=active]:text-[#FF69B4]">
            ...
            <Card className="border-gray-200 dark:border-gray-700 dark:bg-gray-800 shadow-sm">
              <CardContent className="p-5">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <Badge className="bg-[#FF69B4] text-white border-none">Complete</Badge>
                </div>

                <div className="grid grid-cols-2 gap-3 mb-4">
                  <div className="bg-[#FFE6F7] dark:bg-pink-900/30 rounded-xl p-3">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" className="flex-1 border-[#FF69B4] text-[#FF69B4] hover:bg-[#FFE6F7] dark:hover:bg-pink-900/30">
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-[#FFE6F7] dark:bg-pink-900/30 rounded-lg flex items-center justify-center">
                      ...
                      <div className="flex items-center gap-2">
                        <Badge className="bg-[#FF69B4] text-white text-xs border-none">{report.status}</Badge>
                        <Button size="sm" variant="ghost" className="text-[#FF69B4]">
        ...
        <TabsContent value="appointments" className="space-y-6">
          ...
          <div>
            ...
            <Card className="border-[#FF69B4] dark:border-pink-700 bg-gradient-to-br from-[#FFE6F7] dark:from-pink-900/30 to-white dark:to-gray-800 shadow-md">
              <CardContent className="p-0">
                <div className="h-40 bg-cover bg-center rounded-t-lg relative overflow-hidden">
                  ...
                  <Badge className="absolute top-4 left-4 bg-[#FF69B4] text-white border-none">
                    Tomorrow
                  </Badge>
                </div>
                <div className="p-5">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      <Video className="w-4 h-4 text-[#FF69B4]" />
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    <Button variant="outline" className="border-[#FF69B4] text-[#FF69B4] hover:bg-[#FFE6F7] dark:hover:bg-pink-900/30">
                      Reschedule
                    </Button>
                  </div>
                </div>
            ...
            <div className="space-y-3">
              {[
                ...
                <Card key={idx} className="border-gray-200 dark:border-gray-700 dark:bg-gray-800 shadow-sm">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#FFE6F7] dark:bg-pink-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
