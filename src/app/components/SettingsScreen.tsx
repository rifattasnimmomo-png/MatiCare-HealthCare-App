...
export function SettingsScreen() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 min-h-screen pb-24">
      {/* Header */}
      <div className="bg-[#FFC0CB] px-6 pt-12 pb-8">
      ...
      <div className="px-6 py-6">
        ...
        <Card className="border-gray-200 dark:border-gray-700 dark:bg-gray-800">
          <CardContent className="p-5">
            <button className="w-full flex items-center justify-between p-4 bg-[#FFE4E9] dark:bg-pink-900/30 rounded-xl hover:opacity-80 transition-opacity">
              <div className="flex items-center gap-3">
                <Smartphone className="w-6 h-6 text-[#FFC0CB]" />
            ...
            <div className="mt-4 space-y-3">
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#FFC0CB]/20 rounded-lg flex items-center justify-center">
                    <Bluetooth className="w-5 h-5 text-[#FFC0CB]" />
                  </div>
                  <div>
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg opacity-60">
                ...
                <button className="text-xs text-[#FFC0CB]">Pair</button>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-3">
              <button 
                ...
                className={`w-full flex items-center justify-between p-4 rounded-xl transition-colors ${
                  theme === 'light' 
                    ? 'bg-[#FFE4E9] dark:bg-pink-900/30 border-2 border-[#FFC0CB]' 
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white dark:bg-gray-800 rounded-lg flex items-center justify-center">
                    <Sun className="w-5 h-5 text-[#FFC0CB]" />
                  </div>
                  <div className="text-left">
                ...
                {theme === 'light' ? (
                  <div className="w-5 h-5 bg-[#FFC0CB] rounded-full flex items-center justify-center">
